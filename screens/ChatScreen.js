...
import { addGroupMessage } from '../redux/ActionCreators';
...
const mapDispatchToProps = (dispatch) =>({
    addGroupMessage : (mssg) => dispatch(addGroupMessage(mssg))
})
        ...
        return (
            <SafeAreaView style={styles.chatArea}>
                ...
                <KeyboardAvoidingView  style={{ flex: 1}} >
                    <FlatList
                        inverted = {true}
                        data={this.props.messages.mssgobj}
                        ...
                        <TouchableOpacity style={{flex:1, justifyContent:'center'}} onPress={() => { console.log('button') }}>
                            ...
                            <Feather name="send" size={30} color="black" 
                                onPress={()=>{
                                    ...
                                    this.props.addGroupMessage({sender: user, 
